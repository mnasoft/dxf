...
(progn
  ...
  (defparameter *t-0* (make-instance 'db-text
  ...
  (dxf-out-binary *t-0* *o*)
  (dxf-out-b-string 0 *endsec* *o*) (dxf-out-b-string 0 *eof* *o*)
  (close *o*))

(progn ;;;;Db-Ray
  (defparameter *o* (open "e:/PRG/msys64/home/namatv/12345.dxf" :direction :output :if-exists :supersede))
  (defparameter *r* ( make-instance 'Db-Ray :base-point (vector 51 65 0) :unit-dir (vector 1 0 0)))
  (dxf-out *r* *o*)
  (close *o*)
  )
