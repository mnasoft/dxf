...
3. [0/1] Добавить функции тестирования:
   - [ ] посекционного чтения - записи бинарное dxf - файла;
4. [X] Выполнить отладку по кодам от 290 по 299 (запись boolean) - добавлены функции:
