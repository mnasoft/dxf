(defclass acad-groups (acad-object)
  ...
  (:documentation "The collection of all groups in the drawing."))

(defparameter *acad-groups-properties* '(ac-application ac-count ac-document ac-handle ac-has-extension-dictionary ac-object-id ac-object-name ac-owner-id))

(mapcar #'make-slot (set-difference *acad-groups-properties* *acad-object-properties*))