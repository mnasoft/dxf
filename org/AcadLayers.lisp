(defclass <acad-layers> (<acad-object>)
  ...
  (:documentation "The collection of all layers in the drawing."))

(defparameter *acad-layers-properties* '(ac-application ac-count ac-document ac-handle ac-has-extension-dictionary ac-object-id ac-object-name ac-owner-id))
