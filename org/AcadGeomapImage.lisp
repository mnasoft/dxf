(defclass acad-geomap-image (acad-raster-image)
  ...
  (ac-geo-image-brightness     :accessor ac-geo-image-brightness     :initarg :ac-geo-image-brightness     :initform nil :documentation "ac-geo-image-brightness")
  (ac-geo-image-contrast       :accessor ac-geo-image-contrast       :initarg :ac-geo-image-contrast       :initform nil :documentation "ac-geo-image-contrast")
  (ac-geo-image-fade           :accessor ac-geo-image-fade           :initarg :ac-geo-image-fade           :initform nil :documentation "ac-geo-image-fade")
  (ac-geo-image-height         :accessor ac-geo-image-height         :initarg :ac-geo-image-height         :initform nil :documentation "ac-geo-image-height")
  (ac-geo-image-position       :accessor ac-geo-image-position       :initarg :ac-geo-image-position       :initform nil :documentation "ac-geo-image-position")
  (ac-geo-image-width          :accessor ac-geo-image-width          :initarg :ac-geo-image-width          :initform nil :documentation "ac-geo-image-width")
  ...
  (:documentation "An embedded raster image which is captured from a portion of LiveMap."))
