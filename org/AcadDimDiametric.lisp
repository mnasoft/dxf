(defclass acad-dim-diametric (acad-dimension)
  ...
  (:documentation "A dimension measuring the diameter of a circle or arc."))
...
(mapcar #'make-slot (set-difference *acad-dim-diametric-properties* *acad-dimension-properties*))