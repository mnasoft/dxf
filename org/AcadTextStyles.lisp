(defclass acad-text-styles (acad-object)
  ...
  (:documentation "The collection of all text styles in the drawing."))

(defparameter *acad-text-styles-properties* '(ac-application ac-count ac-document ac-handle ac-has-extension-dictionary ac-object-id ac-object-name ac-owner-id))

(mapcar #'make-slot (set-difference *acad-text-styles-properties* *acad-object-properties*))