...
(defun dxf-out-b (code value stream)
  ""
  (cond
    ((<= 0 code 9)       (dxf-out-b-string code value stream)) ;;;; String (with the introduction of extended symbol names in AutoCAD 2000, the 255-character limit has been increased to 2049 single-byte characters not including the newline at the end of the line)
    ((<= 10 code 39)     (dxf-out-b-double code value stream)) ;;;; Double precision 3D point value
    ...
    ((<= 310 code 319)   (dxf-out-b-string code value stream :max-octet-length 127)) ;;;; String representing hex value of b chunk
    ((<= 320 code 329)   (dxf-out-b-string code value stream :max-octet-length 127)) ;;;; String representing hex handle value
    ((<= 330 code 369)   (dxf-out-b-string code value stream :max-octet-length 127)) ;;;; String representing hex object IDs
