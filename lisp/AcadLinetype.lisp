...
(defclass <acad-linetype> (<acad-object>)
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-16016CA5-0126-403B-844B-F6CABE117B50\"](Linetype Object (ActiveX))"))

(defparameter *acad-linetype-properties* '(pr-application pr-description pr-document pr-handle pr-has-extension-dictionary pr-name pr-object-id pr-object-name pr-owner-id))
