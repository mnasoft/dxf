...
(defclass <acad-blocks> (<acad-object>)
  (
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-E77CC5AD-74B8-472C-8270-32FD162D5653\"](Blocks Collection (ActiveX))"))

(defparameter *acad-blocks-properties* '(pr-application pr-count pr-document pr-handle pr-has-extension-dictionary pr-object-id pr-object-name pr-owner-id))

(mapcar #'dxf/utils:make-slot (set-difference *acad-blocks-properties* *acad-object-properties*))
