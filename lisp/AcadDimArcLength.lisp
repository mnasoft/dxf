...
(defclass <acad-dim-arc-length> (<acad-dimension>)
  (
   ...
   (ac-arc-end-param               :accessor ac-arc-end-param            :initarg :ac-arc-end-param            :initform nil :documentation "ac-arc-end-param")
   (ac-arc-point                   :accessor ac-arc-point                :initarg :ac-arc-point                :initform nil :documentation "ac-arc-point")
   (ac-arc-start-param             :accessor ac-arc-start-param          :initarg :ac-arc-start-param          :initform nil :documentation "ac-arc-start-param")
   ...
   (ac-center-point                :accessor ac-center-point             :initarg :ac-center-point             :initform nil :documentation "ac-center-point")
   ...
   (ac-dimension-line-extend       :accessor ac-dimension-line-extend    :initarg :ac-dimension-line-extend    :initform nil :documentation "ac-dimension-line-extend")
   ...
   (ac-ext-line1-point             :accessor ac-ext-line1-point          :initarg :ac-ext-line1-point          :initform nil :documentation "ac-ext-line1-point")
   ...
   (ac-ext-line2-point             :accessor ac-ext-line2-point          :initarg :ac-ext-line2-point          :initform nil :documentation "ac-ext-line2-point")
   ...
   (ac-has-leader                  :accessor ac-has-leader               :initarg :ac-has-leader               :initform nil :documentation "ac-has-leader")
   ...
   (ac-is-partial                  :accessor ac-is-partial               :initarg :ac-is-partial               :initform nil :documentation "ac-is-partial")
   (ac-layer                       :accessor ac-layer                    :initarg :ac-layer                    :initform nil :documentation "ac-layer")
   (ac-leader1-point               :accessor ac-leader1-point            :initarg :ac-leader1-point            :initform nil :documentation "ac-leader1-point")
   (ac-leader2-point               :accessor ac-leader2-point            :initarg :ac-leader2-point            :initform nil :documentation "ac-leader2-point")
   ...
   (ac-symbol-position             :accessor ac-symbol-position          :initarg :ac-symbol-position          :initform nil :documentation "ac-symbol-position")
  ...
  (:documentation "
https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-BAB6D518-BE01-494A-A8AC-8645A99369CE
"))

(defparameter *acad-dim-arc-length-properties* '(ac-alt-round-distance ac-alt-sub-units-factor ac-alt-sub-units-suffix ac-alt-suppress-leading-zeros ac-alt-suppress-trailing-zeros ac-alt-suppress-zero-feet ac-alt-suppress-zero-inches ac-alt-text-prefix ac-alt-text-suffix ac-alt-tolerance-precision ac-alt-tolerance-suppress-leading-zeros ac-alt-tolerance-suppress-trailing-zeros ac-alt-tolerance-suppress-zero-feet ac-alt-tolerance-suppress-zero-inches ac-alt-units ac-alt-units-format ac-alt-units-precision ac-alt-units-scale ac-application ac-arc-end-param ac-arc-point ac-arc-start-param ac-arrowhead1-block ac-arrowhead1-type ac-arrowhead2-block ac-arrowhead2-type ac-arrowhead-size ac-center-point ac-decimal-separator ac-dimension-line-color ac-dimension-line-extend ac-dimension-linetype ac-dimension-line-weight ac-dim-line1-suppress ac-dim-line2-suppress ac-dim-line-inside ac-dim-txt-direction ac-document ac-entity-transparency ac-extension-line-color ac-extension-line-extend ac-extension-line-offset ac-extension-line-weight ac-ext-line1-linetype ac-ext-line1-point ac-ext-line1-suppress ac-ext-line2-linetype ac-ext-line2-point ac-ext-line2-suppress ac-ext-line-fixed-len ac-ext-line-fixed-len-suppress ac-fit ac-force-line-inside ac-fraction-format ac-handle ac-has-extension-dictionary ac-has-leader ac-horizontal-text-position ac-hyperlinks ac-is-partial ac-layer ac-leader1-point ac-leader2-point ac-linear-scale-factor ac-linetype ac-linetype-scale ac-lineweight ac-material ac-measurement ac-normal ac-object-id ac-object-name ac-owner-id ac-plot-style-name ac-primary-units-precision ac-rotation ac-round-distance ac-scale-factor ac-style-name ac-sub-units-factor ac-sub-units-suffix ac-suppress-leading-zeros ac-suppress-trailing-zeros ac-suppress-zero-feet ac-suppress-zero-inches ac-symbol-position ac-text-color ac-text-fill ac-text-fill-color ac-text-gap ac-text-height ac-text-inside ac-text-inside-align ac-text-movement ac-text-outside-align ac-text-override ac-text-position ac-text-prefix ac-text-rotation ac-text-style ac-text-suffix ac-tolerance-display ac-tolerance-height-scale ac-tolerance-justification ac-tolerance-lower-limit ac-tolerance-precision ac-tolerance-suppress-leading-zeros ac-tolerance-suppress-trailing-zeros ac-tolerance-suppress-zero-feet ac-tolerance-suppress-zero-inches ac-tolerance-upper-limit ac-true-color ac-units-format ac-vertical-text-position ac-visible))
