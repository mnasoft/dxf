...
(defclass <acad-swept-surface> (<acad-surface>)
  ...
  (pr-bank                     :accessor pr-bank                     :initarg :pr-bank                     :initform nil :documentation "pr-bank")
  ...
  (pr-profile-rotation         :accessor pr-profile-rotation         :initarg :pr-profile-rotation         :initform nil :documentation "pr-profile-rotation")
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-2E70AE24-0C8F-4124-84F2-F20A94EA6AF2\"](SweptSurface Object (ActiveX))"))

(defparameter *acad-swept-surface-properties* '(pr-application pr-bank pr-document pr-edge-extension-distances pr-entity-transparency pr-handle pr-has-extension-dictionary pr-hyperlinks pr-layer pr-length pr-linetype pr-linetype-scale pr-lineweight pr-maintain-associativity pr-material pr-object-id pr-object-name pr-owner-id pr-plot-style-name pr-profile-rotation pr-scale pr-show-associativity pr-surface-type pr-surf-trim-associativity pr-true-color pr-twist pr-u-isoline-density pr-visible pr-v-isoline-density pr-wireframe-type))
