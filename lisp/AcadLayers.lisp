...
(defclass <acad-layers> (<acad-object>)
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-D9F62B4B-401E-4AE6-969F-3F7756819EB6\"](Layers Collection (ActiveX))"))

(defparameter *acad-layers-properties* '(pr-application pr-count pr-document pr-handle pr-has-extension-dictionary pr-object-id pr-object-name pr-owner-id))

(mapcar #'dxf/utils:make-slot (set-difference *acad-layers-properties* *acad-object-properties*))
