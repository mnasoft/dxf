...
(defclass <acad-views> (<acad-object>)
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-786FCD2B-E5F8-4BFA-B69F-F871AF4503CA\"](Views Collection (ActiveX))"))

(defparameter *acad-views-properties* '(pr-application pr-count pr-document pr-handle pr-has-extension-dictionary pr-object-id pr-object-name pr-owner-id))
