...
(defclass <acad-m-insert-block> (<acad-block-reference>)
  ...
  (ac-column-spacing           :accessor ac-column-spacing           :initarg :ac-column-spacing           :initform nil :documentation "ac-column-spacing")
  ...
  (ac-row-spacing              :accessor ac-row-spacing              :initarg :ac-row-spacing              :initform nil :documentation "ac-row-spacing")
