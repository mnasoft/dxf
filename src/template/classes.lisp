...
"
A Objects Reference (ActiveX)

These ActiveX objects all start with 'A'.
Objects
AcadState
...
B Objects Reference (ActiveX)

These ActiveX objects all start with 'B'.
Objects
Block
...
C Objects Reference (ActiveX)

These ActiveX objects all start with 'C'.
Objects
Circle
A full circle.

D Objects Reference (ActiveX)

These ActiveX objects all start with 'D'.
Objects
Database
...
E Objects Reference (ActiveX)

These ActiveX objects all start with 'E'.
Objects
Ellipse
...
F Objects Reference (ActiveX)

These ActiveX objects all start with 'F'.
Objects
...
G Objects Reference (ActiveX)

These ActiveX objects all start with 'G'.
Objects
GeomapImage
...
H Objects Reference (ActiveX)

These ActiveX objects all start with 'H'.
Objects
Hatch
...
I Objects Reference (ActiveX)

These ActiveX objects all start with 'I'.
Objects
...
L Objects Reference (ActiveX)

These ActiveX objects all start with 'L'.
Objects
Layer
...
M Objects Reference (ActiveX)

These ActiveX objects all start with 'M'.
Objects
Material
...
N Objects Reference (ActiveX)

These ActiveX objects all start with 'N'.
Objects
NurbSurface
...
O Objects Reference (ActiveX)

These ActiveX objects all start with 'O'.
Objects
OLE
An AutoCAD OLE object.

P Objects Reference (ActiveX)

These ActiveX objects all start with 'P'.
Objects
...
R Objects Reference (ActiveX)

These ActiveX objects all start with 'R'.
Objects
RasterImage
...
S Objects Reference (ActiveX)

These ActiveX objects all start with 'S'.
Objects
Section
...
T Objects Reference (ActiveX)

These ActiveX objects all start with 'T'.
Objects
Table
...
U Objects Reference (ActiveX)

These ActiveX objects all start with 'U'.
Objects
UCS
...
V Objects Reference (ActiveX)

These ActiveX objects all start with 'V'.
Objects
View
...
W Objects Reference (ActiveX)

These ActiveX objects all start with 'W'.
Objects
Wipeout
Masking object that hides the objects below it in the current draw order.

X Objects Reference (ActiveX)

These ActiveX objects all start with 'X'.
Objects
XLine
