...
(defclass <acad-registered-application> (<acad-object>)
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-62AD8980-F707-4906-8640-B3C54E9FC3F4\"](RegisteredApplication Object (ActiveX))"))

(defparameter *acad-registered-application-properties* '(pr-application pr-document pr-handle pr-has-extension-dictionary pr-name pr-object-id pr-object-name pr-owner-id))
