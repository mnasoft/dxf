...
(defclass <acad-layouts> (<acad-object>)
  (
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-0C5AF331-03C4-472B-BD30-78C8310822A2\"](Layouts Collection (ActiveX))"))

(defparameter *acad-layouts-properties* '(pr-application pr-count pr-document pr-handle pr-has-extension-dictionary pr-object-id pr-object-name pr-owner-id))

(mapcar #'dxf/utils:make-slot (set-difference *acad-layouts-properties* *acad-object-properties*))
