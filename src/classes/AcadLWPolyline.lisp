...
(defclass <acad-lwpolyline> (<acad-entity>)
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-5A604B98-B6DE-42C3-97D9-98B8CAEBB507\"](LWPolyline Object (ActiveX))"))

(defparameter *acad-lw-polyline-properties* '(pr-application pr-area pr-closed pr-constant-width pr-coordinate pr-coordinates pr-document pr-elevation pr-entity-transparency pr-handle pr-has-extension-dictionary pr-hyperlinks pr-layer pr-length pr-linetype pr-linetype-generation pr-linetype-scale pr-lineweight pr-material pr-normal pr-object-id pr-object-name pr-owner-id pr-plot-style-name pr-thickness pr-true-color pr-visible))

(mapcar #'dxf/utils:make-slot (set-difference *acad-lw-polyline-properties* *acad-entity-properties*))
