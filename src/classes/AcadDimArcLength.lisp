...
(defclass <acad-dim-arc-length> (<acad-dimension>)
  (
   ...
   (pr-arc-end-param               :accessor pr-arc-end-param            :initarg :pr-arc-end-param            :initform nil :documentation "pr-arc-end-param")
   (pr-arc-point                   :accessor pr-arc-point                :initarg :pr-arc-point                :initform nil :documentation "pr-arc-point")
   (pr-arc-start-param             :accessor pr-arc-start-param          :initarg :pr-arc-start-param          :initform nil :documentation "pr-arc-start-param")
   ...
   (pr-center-point                :accessor pr-center-point             :initarg :pr-center-point             :initform nil :documentation "pr-center-point")
   ...
   (pr-ext-line1-point             :accessor pr-ext-line1-point          :initarg :pr-ext-line1-point          :initform nil :documentation "pr-ext-line1-point")
   ...
   (pr-ext-line2-point             :accessor pr-ext-line2-point          :initarg :pr-ext-line2-point          :initform nil :documentation "pr-ext-line2-point")
   ...
   (pr-has-leader                  :accessor pr-has-leader               :initarg :pr-has-leader               :initform nil :documentation "pr-has-leader")
   ...
   (pr-is-partial                  :accessor pr-is-partial               :initarg :pr-is-partial               :initform nil :documentation "pr-is-partial")
   (pr-layer                       :accessor pr-layer                    :initarg :pr-layer                    :initform nil :documentation "pr-layer")
   (pr-leader1-point               :accessor pr-leader1-point            :initarg :pr-leader1-point            :initform nil :documentation "pr-leader1-point")
   (pr-leader2-point               :accessor pr-leader2-point            :initarg :pr-leader2-point            :initform nil :documentation "pr-leader2-point")
   ...
   (pr-symbol-position             :accessor pr-symbol-position          :initarg :pr-symbol-position          :initform nil :documentation "pr-symbol-position")
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-BAB6D518-BE01-494A-A8AC-8645A99369CE\"](DimArcLength Object (ActiveX))"))

(defparameter *acad-dim-arc-length-properties* '(pr-alt-round-distance pr-alt-sub-units-factor pr-alt-sub-units-suffix pr-alt-suppress-leading-zeros pr-alt-suppress-trailing-zeros pr-alt-suppress-zero-feet pr-alt-suppress-zero-inches pr-alt-text-prefix pr-alt-text-suffix pr-alt-tolerance-precision pr-alt-tolerance-suppress-leading-zeros pr-alt-tolerance-suppress-trailing-zeros pr-alt-tolerance-suppress-zero-feet pr-alt-tolerance-suppress-zero-inches pr-alt-units pr-alt-units-format pr-alt-units-precision pr-alt-units-scale pr-application pr-arc-end-param pr-arc-point pr-arc-start-param pr-arrowhead1-block pr-arrowhead1-type pr-arrowhead2-block pr-arrowhead2-type pr-arrowhead-size pr-center-point pr-decimal-separator pr-dimension-line-color pr-dimension-line-extend pr-dimension-linetype pr-dimension-line-weight pr-dim-line1-suppress pr-dim-line2-suppress pr-dim-line-inside pr-dim-txt-direction pr-document pr-entity-transparency pr-extension-line-color pr-extension-line-extend pr-extension-line-offset pr-extension-line-weight pr-ext-line1-linetype pr-ext-line1-point pr-ext-line1-suppress pr-ext-line2-linetype pr-ext-line2-point pr-ext-line2-suppress pr-ext-line-fixed-len pr-ext-line-fixed-len-suppress pr-fit pr-force-line-inside pr-fraction-format pr-handle pr-has-extension-dictionary pr-has-leader pr-horizontal-text-position pr-hyperlinks pr-is-partial pr-layer pr-leader1-point pr-leader2-point pr-linear-scale-factor pr-linetype pr-linetype-scale pr-lineweight pr-material pr-measurement pr-normal pr-object-id pr-object-name pr-owner-id pr-plot-style-name pr-primary-units-precision pr-rotation pr-round-distance pr-scale-factor pr-style-name pr-sub-units-factor pr-sub-units-suffix pr-suppress-leading-zeros pr-suppress-trailing-zeros pr-suppress-zero-feet pr-suppress-zero-inches pr-symbol-position pr-text-color pr-text-fill pr-text-fill-color pr-text-gap pr-text-height pr-text-inside pr-text-inside-align pr-text-movement pr-text-outside-align pr-text-override pr-text-position pr-text-prefix pr-text-rotation pr-text-style pr-text-suffix pr-tolerance-display pr-tolerance-height-scale pr-tolerance-justification pr-tolerance-lower-limit pr-tolerance-precision pr-tolerance-suppress-leading-zeros pr-tolerance-suppress-trailing-zeros pr-tolerance-suppress-zero-feet pr-tolerance-suppress-zero-inches pr-tolerance-upper-limit pr-true-color pr-units-format pr-vertical-text-position pr-visible))

(mapcar #'dxf/utils:make-slot (set-difference *acad-dim-arc-length-properties* *acad-dimension-properties*))
