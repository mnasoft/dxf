...
'((:methods    "AppendVertex ArrayPolar ArrayRectangular Copy Delete Explode GetBoundingBox GetBulge GetExtensionDictionary GetWidth GetXData Highlight IntersectWith Mirror Mirror3D Move Offset Rotate Rotate3D ScaleEntity SetBulge SetWidth SetXData TransformBy Update")
  (:properties "Application Area Closed ConstantWidth Coordinate Coordinates Document Elevation EntityTransparency Handle HasExtensionDictionary Hyperlinks Layer Length Linetype LinetypeGeneration LinetypeScale Lineweight Material Normal ObjectID ObjectName OwnerID PlotStyleName Thickness TrueColor Type Visible")
  (:events     "Modified"))
