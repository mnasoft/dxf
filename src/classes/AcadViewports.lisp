...
(defclass <acad-viewports> (<acad-object>)
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-5C011DBD-1D92-4DF6-B0D5-9C12CD913273\"](Viewports Collection (ActiveX))"))

(defparameter *acad-viewports-properties* '(pr-application pr-count pr-document pr-handle pr-has-extension-dictionary pr-object-id pr-object-name pr-owner-id))
