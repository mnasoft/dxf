...
(defclass <acad-layout> (<acad-plot-configuration>)
  ...
  (pr-tab-order                :accessor pr-tab-order                :initarg :pr-tab-order                :initform nil :documentation "pr-tab-order")
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-EFC848F1-26BE-4EFA-BC0E-11F874D73842\"](Layout Object (ActiveX))"))

(defparameter *acad-layout-properties* '(pr-application pr-block pr-canonical-media-name pr-center-plot pr-config-name pr-document pr-handle pr-has-extension-dictionary pr-model-type pr-name pr-object-id pr-object-name pr-owner-id pr-paper-units pr-plot-hidden pr-plot-origin pr-plot-rotation pr-plot-type pr-plot-viewport-borders pr-plot-viewports-first pr-plot-with-lineweights pr-plot-with-plot-styles pr-scale-lineweights pr-show-plot-styles pr-standard-scale pr-style-sheet pr-tab-order pr-use-standard-scale pr-view-to-plot))

(mapcar #'dxf/utils:make-slot (set-difference *acad-layout-properties* *acad-plot-configuration-properties*))
