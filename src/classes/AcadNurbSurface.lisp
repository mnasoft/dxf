...
(defclass <acad-nurb-surface> (<acad-surface>)
  ...
  (pr-cv-hull-display          :accessor pr-cv-hull-display          :initarg :pr-cv-hull-display          :initform nil :documentation "pr-cv-hull-display")
