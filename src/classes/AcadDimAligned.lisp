...
(defclass <acad-dim-aligned> (<acad-dimension>)
  (
  ...
  (pr-ext-line-fixed-len-supress :accessor pr-ext-line-fixed-len-supress :initarg :pr-ext-line-fixed-len-supress :initform nil :documentation "pr-ext-line-fixed-len-supress")
