...
(defclass <acad-dim-styles> (<acad-object>)
  (
  ...
  (:documentation "
@link[uri=\"https://help.autodesk.com/view/ACD/2022/RUS/?guid=GUID-46478963-D723-44E1-92F2-3E28384E64EA\"](DimStyles Collection (ActiveX))"))

(defparameter *acad-dim-styles-properties* '(pr-application pr-count pr-document pr-handle pr-has-extension-dictionary pr-object-id pr-object-name pr-owner-id))

(mapcar #'dxf/utils:make-slot (set-difference *acad-dim-styles-properties* *acad-object-properties*))
