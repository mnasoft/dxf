...
(defun index-to-rgb (index)
  "@b(Описание:) функция @b(index-to-rgb) преобразует @b(index)
в диапазоне от 1 до 256 в представление rgb.

 @b(Пример использования:) @begin[lang=lisp](code)
 (index-to-rgb 0) => NIL 
 (index-to-rgb 1) => (255 0   0)
 (index-to-rgb 2) => (255 255 0)
 (index-to-rgb 4) => (0   255 255)
 (index-to-rgb 7) => (255 255 255)
 (index-to-rgb 250) => (51 51 51)
 (index-to-rgb 253) => (173 173 173)
@end(code)
"
  (cadr (assoc index +index-to-rgb+)))
...
(defun true-to-rgb (truecolor)
  "Примеры использования:
 (true-to-rgb *byblock*)
 (true-to-rgb *bylayer*)
 (true-to-rgb -1032662993)
 (true-to-rgb -7524399)
 (true-to-rgb 7524399)
"
...
@end(code)
"
  (rgb-to-true (index-to-rgb index)))
